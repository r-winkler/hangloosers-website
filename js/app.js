...
$(function () {
    ...
    var jmediaquery = window.matchMedia("(max-width: 767px)")  // this is the value of the xs-layout
    ...
    $('#flipcountdownbox1').flipcountdown({
        ...
        tick: function customTick(dateStr) {
            ...
            var beforeDateTime = Math.round((new Date('09/07/2017 00:00:00')).getTime() / 1000);
    ...
    $('#flipcountdownbox2').flipcountdown({
        ...
        tick: function customTick(dateStr) {
            ...
            var beforeDateTime = Math.round((new Date('09/16/2017 00:00:00')).getTime() / 1000);
            var actualDateTime = Math.round((new Date()).getTime() / 1000);
            if (beforeDateTime < actualDateTime) {
                return [nol(0), nol(0), nol(0), nol(0)];
            }
